...
export function calculateShipping(weight, country, orderTotal) {
  ...
  else if(weight <= 1 && weight >=5  &&  country == "US" && orderTotal >= 51){
    price =  0 
  }


  else if(weight <= 1 && country == "US" && orderTotal <= 50 ){
      price += 5 
  }

  else if (weight <= 5  && country == "US" && orderTotal <= 50 ){
    price += 10
  }
  ...
  // for international 
  else if (weight > 0  && weight > 5 && country != "US" && orderTotal > 100 ){
    price += 0
  }


  else if (weight > 0 && weight <= 1 && country != "US" && orderTotal <=100 ){
     price += 15 
  }
   

    else if (weight > 1 && weight <= 5 && country != "US" && orderTotal <= 100 ){
     price += 25
  }


    else if (weight > 5  && country != "US" && orderTotal <= 100 ){
     price += 40
  }
...
console.log(calculateShipping(0.5,"IN" ,202))